  ...
  return (
    <footer className="bg-white border-t border-secondary-200">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <ul className="space-y-3">
              {navigation.main.map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.href}
                    className="text-secondary-600 hover:text-secondary-900 transition-colors duration-200 text-sm"
                  >
                    {item.name}
                  </Link>
                </li>
        ...
        {/* Bottom section */}
        <div className="mt-8 pt-8 border-t border-secondary-200 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-secondary-600 text-sm">
            © {currentYear} OneMillion. Todos los derechos reservados.
          </p>
          <p className="text-secondary-500 text-sm mt-2 sm:mt-0">
